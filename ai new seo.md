...
title: ИИ-индексация - новое SEO
description: Почему классическая оптимизация устаревает и почему Notepub идеально подходит под новую реальность
---

# ИИ-индексация - новое SEO

Почему классическая оптимизация устаревает и почему [[notepub-hub|Notepub]] идеально подходит под новую реальность
...
[[notepub-hub|Notepub]] был задуман как платформа для публикации знаний, а не еще один конструктор сайтов. Парадоксально, но именно это делает его идеальным решением для новой эпохи ИИ-поиска.

Вот почему [[notepub-hub|Notepub]] - лучший формат для ИИ-индексации:
### Плоская структура URL - идеальный доступ для ИИ моделей

В [[notepub-hub|Notepub]] каждая заметка доступна по прямому URL без вложенности и сложных путей вида:
...
Каждый документ [[notepub-hub|Notepub]] содержит фронтматтер:
...
Ни один классический конструктор не даёт такого чистого DOM для LLM, как [[notepub-hub|Notepub]].

Сайты на Tilda или WordPress создают огромную DOM-матрицу, где полезный текст занимает 15–30% контента страницы. На [[notepub-hub|Notepub]] почти 100%.
...
[[notepub-hub|Notepub]] обеспечивает автоматическую публикацию изменений из Obsidian, гибкость структуры заметок без потери URL, SEO-сигнал "страница актуальна" без перестройки сайта.

Вы публикуете Markdown → [[notepub-hub|Notepub]]]сохраняет архитектуру → LLM получает свежий и чистый контент.
...
Категории во фронтматтере [[notepub-hub|Notepub]] как раз создают такой остров:
...
LLM видит логические связи между заметками, потому что категории в [[notepub-hub|Notepub]] - не просто навигация, а семантические маркеры.
...
ИИ увидит этот фрагмент точно так же, потому что [[notepub-hub|Notepub]] подаёт его читабельно и семантически чисто.
...
Это именно то, для чего построен [[notepub-hub|Notepub]]. Если WordPress - это площадка для сайтов,  
то [[notepub-hub|Notepub]] - это площадка для знаний, а знания и есть основной топливо ИИ-моделей.

[[notepub-hub|Notepub]] случайно оказался идеальным решением именно под эту эпоху. Он создавался как инструмент для публикации личных знаний, но стал лучшей платформой для ИИ-индексации.